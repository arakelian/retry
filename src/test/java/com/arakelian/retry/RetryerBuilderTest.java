...
public class RetryerBuilderTest {
        ...
        final Runnable r = new Runnable() {
            ...
            public void run() {
                final Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                        ...
                        .retryIfResult(Predicates.<Boolean> isNull()).build();
                try {
    ...
    public void testMultipleRetryConditions() throws ExecutionException, RetryException {
        ...
        Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                .retryIfResult(Predicates.<Boolean> isNull()).retryIfExceptionOfType(IOException.class)
        ...
        retryer = RetryerBuilder.<Boolean> newBuilder().retryIfResult(Predicates.<Boolean> isNull())
    ...
    public void testRetryIfException() throws ExecutionException, RetryException {
        ...
        Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder().retryIfException().build();
        final boolean result = retryer.call(callable);
        assertTrue(result);

        callable = noIOExceptionAfter5Attempts();
        retryer = RetryerBuilder.<Boolean> newBuilder().retryIfException()
    ...
    public void testRetryIfExceptionOfType() throws RetryException, ExecutionException {
        Callable<Boolean> callable = noIOExceptionAfter5Attempts();
        Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                .retryIfExceptionOfType(IOException.class).build();
        assertTrue(retryer.call(callable));
        ...
        callable = noIOExceptionAfter5Attempts();
        retryer = RetryerBuilder.<Boolean> newBuilder().retryIfExceptionOfType(IOException.class)
                .withStopStrategy(StopStrategies.stopAfterAttempt(3)).build();
        try {
            retryer.call(callable);
            fail("RetryException expected");
    ...
    public void testRetryIfExceptionWithPredicate() throws RetryException, ExecutionException {
        ...
        callable = noIOExceptionAfter5Attempts();
        retryer = RetryerBuilder.<Boolean> newBuilder().retryIfException(new Predicate<Throwable>() {
            @Override
            public boolean test(final Throwable t) {
                return t instanceof IOException;
            }
    ...
    public void testRetryIfRuntimeException() throws ExecutionException, RetryException {
        Callable<Boolean> callable = noIOExceptionAfter5Attempts();
        Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder().retryIfRuntimeException().build();
        try {
            retryer.call(callable);
            fail("ExecutionException expected");
        } catch (final ExecutionException e) {
        ...
        callable = noIllegalStateExceptionAfter5Attempts();
        retryer = RetryerBuilder.<Boolean> newBuilder().retryIfRuntimeException()
                .withStopStrategy(StopStrategies.stopAfterAttempt(3)).build();
        try {
            retryer.call(callable);
            fail("RetryException expected");
    ...
    public void testRetryListener_SuccessfulAttempt() throws Exception {
        ...
        final Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                .retryIfResult(Predicates.<Boolean> isNull()).withRetryListener(listener).build();
        assertTrue(retryer.call(callable));
    ...
    public void testRetryListener_WithException() throws Exception {
        ...
        final Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                .retryIfResult(Predicates.<Boolean> isNull()).retryIfException().withRetryListener(listener)
                .build();
        assertTrue(retryer.call(callable));
    ...
    public void testWhetherBuilderFailsForNullStopStrategy() {
        try {
            RetryerBuilder.<Void> newBuilder().withStopStrategy(null).build();
    ...
    public void testWhetherBuilderFailsForNullWaitStrategy() {
        try {
            RetryerBuilder.<Void> newBuilder().withWaitStrategy(null).build();
    ...
    public void testWhetherBuilderFailsForNullWaitStrategyWithCompositeStrategies() {
        try {
            RetryerBuilder.<Void> newBuilder().withWaitStrategy(WaitStrategies.join(null, null)).build();
            fail("Exepcted to fail for null wait strategy");
    ...
    public void testWithBlockStrategy() throws ExecutionException, RetryException {
        ...
        final BlockStrategy blockStrategy = new BlockStrategy() {
            @Override
        ...
        final Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder()
                .withBlockStrategy(blockStrategy).retryIfResult(Predicates.<Boolean> isNull()).build();
        final boolean result = retryer.call(callable);
        assertTrue(result);
    ...
    @Test
    public void testWithMoreThanOneWaitStrategyOneBeingIncremental()
            throws ExecutionException, RetryException {
        final Callable<Boolean> callable = notNullAfter5Attempts();
        final Retryer<Boolean> retryer = RetryerBuilder.<Boolean> newBuilder().withWaitStrategy(
                WaitStrategies.join(
                        WaitStrategies
    ...
    private void assertExceptionAttempt(
            final Attempt actualAttempt,
            final boolean expectedHasException,
    ...
    private void assertResultAttempt(
            final Attempt actualAttempt,
            final boolean expectedHasResult,
